...
//    }
//
//    private void normalizeRecursively(Object arg, Set<Object> visited) {
//        if (arg == null || visited.contains(arg) || isSimple(arg.getClass())) {
//            return;
//        }
//        visited.add(arg);
//
...
//            var expr = expressionParser.parseExpression(ann.value());
